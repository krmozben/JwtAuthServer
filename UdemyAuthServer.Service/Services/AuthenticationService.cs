...
namespace UdemyAuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<Response<TokenDto>> CreateToken(LoginDto loginDto)
        {
            ...
            {
                await _userRefreshTokenService.AddAsync(new UserRefreshToken { UserId = user.Id, Code = token.ResfreshToken, Expiration = token.ResfreshTokenExpiration });
            }
            else
            {
                userRefreshToken.Code = token.ResfreshToken;
        ...
        public async Task<Response<TokenDto>> CreateTokenByRefreshToken(string refreshToken)
        {
            ...
            existRefreshToken.Code = tokenDto.ResfreshToken;
